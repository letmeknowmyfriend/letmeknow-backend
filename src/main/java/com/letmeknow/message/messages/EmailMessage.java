...
public enum EmailMessage {
    ...
    VERIFICATION_EMAIL_LINK1("<a href=http://localhost:9090/auth/member/verification-email?verificationCode="),
    ...
    CHANGE_PASSWORD_EMAIL_LINK1("<a href=http://localhost:9090/auth/member/change-password/"),
