...
public enum EmailEnum {
    ...
    VERIFICATION_EMAIL_CONTENT_1("<a href="),
    VERIFICATION_EMAIL_CONTENT_2("/auth/member/verification-email?verificationCode="),
    VERIFICATION_EMAIL_CONTENT_3(">이메일 인증하기</a>"),
    ...
    CHANGE_PASSWORD_EMAIL_CONTENT_1("<a href="),
    CHANGE_PASSWORD_EMAIL_CONTENT_2("/auth/member/change-password/"),
    CHANGE_PASSWORD_EMAIL_CONTENT_3(">비밀번호 변경하기</a>"),
