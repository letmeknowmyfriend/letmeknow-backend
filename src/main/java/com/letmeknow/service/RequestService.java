        ...
        try {
            emailService.sendMail(Email.builder()
                ...
                .message(new StringBuffer()
                    .append("학교 이름: ").append(boardRequestForm.getSchoolName()).append("<br>")
                    .append("학과 이름: ").append(boardRequestForm.getBranchName()).append("<br>")
                    .append("대학 이름: ").append(boardRequestForm.getCollegeName()).append("<br>")
                    .append("게시판 이름: ").append(boardRequestForm.getBoardName()).append("<br>")
